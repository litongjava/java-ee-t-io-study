...
import com.litongjava.tio.boot.server.wshandler.IndexWebSocketHandler;
...
public class TioBootServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    IndexWebSocketHandler indexWebSocketHandler = new IndexWebSocketHandler();
    ...
    ServerAioHandler serverHandler = new TioBootServerHandler(wsServerConfig, indexWebSocketHandler, httpConfig,
